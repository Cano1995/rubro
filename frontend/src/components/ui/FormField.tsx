...
export function SelectField({ label, error, required, options, value, onChange }: SelectFieldProps) {
  return (
    <div className="space-y-1">
      <label className="block text-xs font-medium text-gray-600">
        {label}{required && <span className="text-red-500 ml-0.5">*</span>}
      ...
      <select
        ...
        className={clsx(baseInput, 'bg-white', error ? 'border-red-400' : 'border-gray-300')}
      >
